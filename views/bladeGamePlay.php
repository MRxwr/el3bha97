...
<div class="question-modal" id="questionModal" style="display: none;">
    <div class="modal-content-wrapper">
        <!-- Team Info Sidebar (Right) -->
        <div class="teams-sidebar">
            <div class="team-box" id="modalTeam1Box">
                <div class="team-name" id="modalTeam1Name">الفريق الأول</div>
                <div class="team-score" id="modalTeam1Score">0</div>
                <div class="team-lifelines">
                    <span>وسائل المساعدة</span>
                    <div class="lifeline-icons">
                        <button class="lifeline-btn" id="modal_team1_lifeline_callFriend" disabled><i class="fas fa-phone"></i></button>
                        <button class="lifeline-btn" id="modal_team1_lifeline_twoAnswers" disabled><i class="fas fa-hand-point-right"></i></button>
                        <button class="lifeline-btn" id="modal_team1_lifeline_doublePoints" disabled><i class="fas fa-times-circle"></i> x2</button>
                    </div>
                </div>
            </div>
            <div class="team-box" id="modalTeam2Box">
                <div class="team-name" id="modalTeam2Name">الفريق الثاني</div>
                <div class="team-score" id="modalTeam2Score">0</div>
                <div class="team-lifelines">
                    <span>وسائل المساعدة</span>
                    <div class="lifeline-icons">
                        <button class="lifeline-btn" id="modal_team2_lifeline_callFriend" disabled><i class="fas fa-phone"></i></button>
                        <button class="lifeline-btn" id="modal_team2_lifeline_twoAnswers" disabled><i class="fas fa-hand-point-right"></i></button>
                        <button class="lifeline-btn" id="modal_team2_lifeline_doublePoints" disabled><i class="fas fa-times-circle"></i> x2</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="question-main-area">
            <div class="question-top-bar">
                ...
                <div class="timer-container">
                    <button id="pauseTimerBtn" class="control-btn"><i class="fas fa-pause"></i></button>
                    <span class="timer-display" id="questionTimer">00:05</span>
                    <button id="resetTimerBtn" class="control-btn"><i class="fas fa-redo"></i></button>
                </div>
                <div class="question-points-badge" id="questionPoints">200 نقطة</div>
            </div>

            <div class="question-content">
                <div class="question-category-info" id="questionCategoryInfo" style="display:none;">
                    <span class="badge bg-danger" id="questionCategory"></span>
                </div>
                <div class="question-text-large" id="questionText">جاري تحميل السؤال...</div>
                <div class="question-media-container" id="questionMedia"></div>
            ...
            <div class="question-bottom-bar">
                <button class="answer-btn" id="showAnswerBtn">الإجابة</button>
                <div id="teamSelection" style="display: none;">
                    <button onclick="markTeamCorrect(1)" id="team1CorrectBtn" class="btn btn-success"></button>
                    <button onclick="markTeamCorrect(2)" id="team2CorrectBtn" class="btn btn-success"></button>
                    <button onclick="markNoCorrect()" class="btn btn-warning">لا أحد</button>
                </div>
                <button id="nextBtn" class="btn btn-primary" style="display: none;">السؤال التالي</button>
            </div>
        </div>
    </div>
</div>
